...
from .types import QueryInstanceBillItem, QueryInstanceBillResponse
...
class AlibabaCloudClient:
    ...
    #         instance_bill_response: QueryInstanceBillResponse = QueryInstanceBillResponse.model_validate(response)
    #         result.extend(instance_bill_response.Data.Items)
    #         next_token = instance_bill_response.Data.NextToken
